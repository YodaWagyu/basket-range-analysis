...
def generate_ai_insight(df, category, brand):
    ...
    📊 ข้อมูล (ห้ามคำนวณเอง ใช้เฉพาะตัวเลขที่มีในตารางนี้):
    {lean_df.to_string(index=False)}
    
    ---
    
    🧠 วิธีอ่านข้อมูล (อ่านอย่างเดียว ห้ามคำนวณ):
    1. **Hero Range (ขายดีสุด):** มองหาช่วง Basket_Range ที่มี TotalSales สูงสุดในปีล่าสุด
    2. **Traffic Generator (คนซื้อบ่อยสุด):** มองหาช่วง Basket_Range ที่มี TotalBills สูงสุดในปีล่าสุด (มักจะเป็นช่วงราคาต่ำกว่า Hero)
    3. **Trend:** ดูว่ายอดขายในช่วง Hero Range ปีนี้เทียบกับปีก่อน เปลี่ยนแปลงยังไง
    4. **เป้าหมายโปรโมชั่น:** ดูช่วงราคาถัดไปที่อยู่ติดกับ Hero Range
    
    ---
    
    ✨ กติกาการเขียน (Style & Format):
    1. **ห้ามใช้ตัวหนา (**...**)** หรือตัวเอียงในเนื้อหาเด็ดขาด
    2. **ห้ามเขียนเป็นย่อหน้ายาวๆ** ให้ใช้ Bullet points เสมอ
    3. **ภาษา:** ใช้ภาษาพูด สุภาพ เป็นกันเอง เหมือนเล่าให้เพื่อนฟัง
    4. **ตัวเลข:** ใช้ตัวเลขจากตารางตรงๆ
       - ยอดขายให้แปลงเป็นหน่วย M THB (หารด้วย 1,000,000)
       - บิลให้แปลงเป็นหน่วย K Bills (หารด้วย 1,000)
       - ต้องมีคอมม่าคั่นหลักพันเสมอ
    
    ---
    
    📝 รูปแบบคำตอบ (ตอบตามโครงสร้างนี้เป๊ะๆ):
    
    #### Insight
    - 🏆 Hero Range (ขายดีสุด): [ระบุช่วงราคา] ยอดขายรวม [ตัวเลข] M THB
    - 🚦 Traffic Generator (ดึงคนเก่งสุด): [ระบุช่วงราคา] จำนวนบิล [ตัวเลข] K Bills
    - 📈 เทรนด์ปีนี้: ช่วง Hero Range ยอดขาย [โตขึ้น/ลดลง] เมื่อเทียบกับปีก่อน
    - 💡 สรุปพฤติกรรม: [วิเคราะห์สั้นๆ ว่าลูกค้ากล้าจ่ายแพงขึ้นหรือเน้นของถูกลง]
    
    #### Action
    - 1. ดันลูกค้ากลุ่ม [ระบุช่วง Traffic]: [แนะนำวิธีจัดโปรฯ ง่ายๆ ให้คนกลุ่มนี้ยอมจ่ายเพิ่มเพื่อขยับไปช่วง Hero]
    - 2. ดันลูกค้ากลุ่ม [ระบุช่วง Hero]: [แนะนำวิธีจัดเซตหรือของแถม ให้คนกลุ่มนี้ซื้อเพิ่มอีกนิดเพื่อไปแตะช่วงราคาถัดไป]
    
    #### Suggest Basket Size
    - 🎯 ยอดซื้อเป้าหมาย: [ระบุราคาเริ่มต้นของ Range ถัดไป] บาท
    - 🗣️ เหตุผล: [อธิบายว่าเป็นยอดที่สูงกว่า Hero Range ปัจจุบันนิดหน่อย ช่วยดึงให้ลูกค้าซื้อเพิ่ม]
    """
