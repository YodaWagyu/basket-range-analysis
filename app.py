...
def generate_ai_insight(df, category, brand):
    ...
    3. การเลือกข้อมูล:
       ...
       - เปรียบเทียบ CURRENT vs SPLY: ใช้ TotalSales ของปีเดียวกันเท่านั้น
    ...
    #### Insight
    - Hero Range คือ ช่วง [ระบุช่วง] ยอดขาย [ระบุจำนวนพร้อมคอมม่า]M THB
    - Traffic Generator คือ ช่วง [ระบุช่วง] จำนวนบิล [ระบุจำนวนพร้อมคอมม่า]K Bills
    - เปรียบเทียบ Hero Range ปีนี้ vs ปีก่อน: เพิ่มขึ้น/ลดลง [คำนวณผลต่าง]M THB
    ...
    - Action 2: [กลยุทธ์เฉพาะเจาะจงเพื่อดึงลูกค้าจาก Hero Range ให้ซื้อเพิ่มไปยัง Range ถัดไป]

    #### Suggest Basket Size
    - แนะนำราคาเป้าหมาย [ระบุตัวเลขราคาเริ่มต้นของ Range ถัดจาก Hero Range] THB
    - เหตุผล: [อธิบายว่าทำไมตัวเลขนี้เหมาะสม โดยอิงจากข้อมูลจริงในตาราง]
    
    ---
    ⚠️ สำคัญ: ตรวจสอบทุกตัวเลขกับตารางก่อนตอบ และใส่คอมม่าคั่นหลักพันทุกครั้ง
    """
